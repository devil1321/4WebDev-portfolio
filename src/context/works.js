export const data = [{
        category: 'UX/UI',
        slides: ['applications/dashboard.jpg','websites/framework.jpg','e-commerce/mademe.jpg','e-commerce/sale-hub.png', 'applications/quiz-app.png', 'websites/portfolio.png', 'applications/todo-app-redux.png'],
        articles: [{
            node: {
